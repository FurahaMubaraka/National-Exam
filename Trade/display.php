...
<body>
    ...
    <section>
        ...
        <tr>
            ...
            <td><?php echo $row['trade_student'] ?></td>
            <td><a href="update.php?upd=<?php echo $row['trade_id'] ?>"><button class="update">Update</button></a></td>
            <td><a href="delete.php?dlt=<?php echo $row['trade_id'] ?>"><button class="delete">Delete</button></a></td>
        </tr>
        <?php
        }
        ?>
