...
<body>
    ...
    <section>
        ...
        <tr>
            ...
            <td><a href="update.php?upd=<?php echo $row['trainer_id'] ?>"><button class="update">Update</button></a></td>
            <td><a href="delete.php?dlt=<?php echo $row['trainer_id'] ?>"><button class="delete">Delete</button></a></td>
        </tr>
        <?php
        }
        ?>
