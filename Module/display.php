...
<body>
    ...
    <section>
        ...
        <?php
        include("connect.php");
        $select=mysqli_query($conn,"SELECT * FROM module");
        $count=1;
        ...
        <tr>
            ...
            <td><a href="update.php?upd=<?php echo $row['module_id'] ?>"><button class="update">Update</button></a></td>
            <td><a href="delete.php?dlt=<?php echo $row['module_id'] ?>"><button class="delete">Delete</button></a></td>
        </tr>
        <?php
        }
        ?>
